...
public class C01_RelativeLocators {
    public static void main(String[] args) throws InterruptedException {
        ...
        //    (aradigimiz web elementin bir ozelligi) + locate edilebilen bir web element'e gore konumu
        ...
        // test etmek icin berlin1 webelementinin id attribute'nun degerine bakalim
