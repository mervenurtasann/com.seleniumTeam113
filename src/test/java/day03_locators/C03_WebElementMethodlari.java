...
public class C03_WebElementMethodlari {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println(aramaKutusuElementi.getText()); // varsa weblement uzerindeki yaziyi getirir

        aramaKutusuElementi.sendKeys("Nutella");
        Thread.sleep(2000);
        aramaKutusuElementi.clear();

        System.out.println(aramaKutusuElementi.getSize()); // (727, 38)
        ...
        System.out.println(aramaKutusuElementi.getRect().getDimension()); // (727, 38)
